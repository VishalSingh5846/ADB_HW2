...
.aq.show `TRADE set ([]Time:"j"$();Symbol:"j"$();Quantity:"j"$();Price:"j"$());

.aq.show .aq.load[hsym `$"trade.txt";",";`TRADE];

.aq.show .aq.save[hsym `$"1.WeightedAverage.csv";","; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[TRADE;"TRADE";0b];
 aq__t0:?[aq__t0;();(enlist[{x^.aq.cd x} `Symbol]!enlist {x^.aq.cd x} `Symbol);({x^.aq.cd x} `Symbol) _ (.aq.wildCard aq__t0)];
 aq__t0:?[aq__t0;();0b;(enlist[`c__0]!enlist (%; (.aq.sum';(*; {x^.aq.cd x} `Price; {x^.aq.cd x} `Quantity)); (.aq.sum';{x^.aq.cd x} `Quantity)))];
 aq__t0
 }[];
...
.aq.show `T2 set {
 ...
 aq__t0:.aq.initTable[TRADE;"TRADE";0b];
 aq__t0:?[aq__t0;();(enlist[{x^.aq.cd x} `Symbol]!enlist {x^.aq.cd x} `Symbol);({x^.aq.cd x} `Symbol) _ (.aq.wildCard aq__t0)];
 aq__t0:.aq.sortGrouped[aq__t0;enlist ((iasc;{x^.aq.cd x} `Time));({x^.aq.cd x} `Time;{x^.aq.cd x} `Symbol;{x^.aq.cd x} `Price)];
 aq__t0:?[aq__t0;();0b;((`Time);(`Symbol);(`Price);(`c__0))!({x^.aq.cd x} `Time;{x^.aq.cd x} `Symbol;{x^.aq.cd x} `Price;(.aq.avgs2';10;{x^.aq.cd x} `Price))];
 aq__t0
 }[];

.aq.show .aq.save[hsym `$"2.MovAvg.csv";","; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[eval (.aq.flatten;T2);"";0b];
...
.aq.show `T3 set {
 ...
 aq__t0:.aq.initTable[TRADE;"TRADE";0b];
 aq__t0:?[aq__t0;();(enlist[{x^.aq.cd x} `Symbol]!enlist {x^.aq.cd x} `Symbol);({x^.aq.cd x} `Symbol) _ (.aq.wildCard aq__t0)];
 aq__t0:.aq.sortGrouped[aq__t0;enlist ((iasc;{x^.aq.cd x} `Time));({x^.aq.cd x} `Time;{x^.aq.cd x} `Symbol;{x^.aq.cd x} `Price;{x^.aq.cd x} `Quantity)];
 aq__t0:?[aq__t0;();0b;((`Time);(`Symbol);(`Price);(`c__0))!({x^.aq.cd x} `Time;{x^.aq.cd x} `Symbol;{x^.aq.cd x} `Price;(%; (.aq.sums2';10;(*; {x^.aq.cd x} `Price; {x^.aq.cd x} `Quantity)); (.aq.sums2';10;{x^.aq.cd x} `Quantity)))];
 aq__t0
 }[];

.aq.show .aq.save[hsym `$"3.MovAvgWeighted.csv";","; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[eval (.aq.flatten;T3);"";0b];
 aq__t0:?[aq__t0;();0b;(.aq.wildCard aq__t0)];
 aq__t0
 }[];
...
.aq.show `T4 set {
 ...
 aq__t0:.aq.initTable[TRADE;"TRADE";0b];
 aq__t0:?[aq__t0;();(enlist[{x^.aq.cd x} `Symbol]!enlist {x^.aq.cd x} `Symbol);({x^.aq.cd x} `Symbol) _ (.aq.wildCard aq__t0)];
 aq__t0:.aq.sortGrouped[aq__t0;enlist ((iasc;{x^.aq.cd x} `Time));({x^.aq.cd x} `Symbol;{x^.aq.cd x} `Price)];
 aq__t0:?[aq__t0;();0b;((`Symbol);(`c__0))!({x^.aq.cd x} `Symbol;(.aq.max';(-; {x^.aq.cd x} `Price; (.aq.mins1';{x^.aq.cd x} `Price))))];
 aq__t0
 }[];

.aq.show .aq.save[hsym `$"4.MaxProfit.csv";","; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[T4;"T4";0b];
 aq__t0:?[aq__t0;();0b;(.aq.wildCard aq__t0)];
 aq__t0
 }[];
exit 0;

...
.aq.show `TFriends set ([]person1:"j"$();person2:"j"$());

.aq.show `TLike set ([]person:"j"$();artist:"j"$());

.aq.show .aq.load[hsym `$"friends.txt";",";`TFriends];

.aq.show .aq.load[hsym `$"like.txt";",";`TLike];

.aq.insert[`TFriends;TFriends;();
 {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[TFriends;"TFriends";0b];
 aq__t0:?[aq__t0;();0b;((`person2);(`person1))!({x^.aq.cd x} `person2;{x^.aq.cd x} `person1)];
 aq__t0
 }[]]

.aq.show `UFriends set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[eval (.aq.distinct;TFriends);"";0b];
 aq__t0:?[aq__t0;();0b;((`person1);(`person2))!({x^.aq.cd x} `person1;{x^.aq.cd x} `person2)];
 aq__t0
 }[];

.aq.show `ULike set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[eval (.aq.distinct;TLike);"";0b];
 aq__t0:?[aq__t0;();0b;((`person);(`artist);(`dummy))!({x^.aq.cd x} `person;{x^.aq.cd x} `artist;1)];
 aq__t0
 }[];

.aq.show `t1 set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[UFriends;"UFriends";0b];
 aq__t0:?[aq__t0;();0b;((`person);(`person2))!({x^.aq.cd x} `person1;{x^.aq.cd x} `person2)];
 aq__t0
 }[];
...
.aq.show `t2 set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[UFriends;"UFriends";0b];
 aq__t0:?[aq__t0;();0b;((`person1);(`person))!({x^.aq.cd x} `person1;{x^.aq.cd x} `person2)];
 aq__t0
 }[];

.aq.show `friend1 set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[t2;"t2";1b];
 aq__t1:.aq.initTable[ULike;"ULike";1b];
 aq__t2:.aq.joinUsing[.aq.ej;aq__t0;aq__t1;enlist ({x^.aq.cd x} `person)];
 aq__t2:?[aq__t2;();0b;((`person1);(`person2);(`artist))!({x^.aq.cd x} `person1;{x^.aq.cd x} `person;{x^.aq.cd x} `artist)];
 aq__t2
 }[];

.aq.show `friend1T set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[friend1;"friend1";0b];
 aq__t0:?[aq__t0;();0b;((`person);(`person2);(`artist))!({x^.aq.cd x} `person1;{x^.aq.cd x} `person2;{x^.aq.cd x} `artist)];
 aq__t0
 }[];

.aq.show .aq.save[hsym `$"X.csv";","; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[friend1T;"friend1T";1b];
 aq__t1:.aq.initTable[ULike;"ULike";1b];
 aq__t2:.aq.joinUsing[.aq.foju;aq__t0;aq__t1;({x^.aq.cd x} `person;{x^.aq.cd x} `artist)];
 aq__t2:?[aq__t2;enlist ((.aq.null;{x^.aq.cd x} `dummy));0b;()];
 aq__t2:?[aq__t2;();0b;((`person1);(`person2);(`artist))!({x^.aq.cd x} `person;{x^.aq.cd x} `person2;{x^.aq.cd x} `artist)];
 aq__t2
 }[];
exit 0;
